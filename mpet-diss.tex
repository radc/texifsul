\documentclass[diss,capa]{texifsuledu}
...
\unidade{Câmpus Pelotas}
\programa{Programa de Pós-graduação em Educação}
\curso{Mestrado Profissional em Educação e Tecnologias}
\areaconhecimento{Educação}
\tituloformacao{Mestre em Educação e Tecnologia}

\unidadeeng{Pelotas Campus}
\programaeng{Postgraduate Program in Education}
\cursoeng{Professional Master in Education and Technologies}

\title{Modelo de Dissertação de Mestrado do Programa de Pós-Graduação em Educação do IFSul}

\author{Conceição}{Ruhan Avila da}
\advisor[Prof.~Dr.]{Sobrenome}{Nome do Orientador e}
\coadvisor[Prof.~Dr.]{Sobrenome}{Nome do Coorientador e}
% \coadvisor[Prof.~Dr.]{Conceição}{Ruhan Coorientador2 da}
% \collaborator[Prof.~Dr.]{Conceição}{Ruhan Colaborador da}
...
\begin{aprovacao}{30 de fevereiro de 2000} %data da banca por extenso
\noindent Prof. Dr. Nome do Orientador e Sobrenome (orientador)\\
Doutor em Computação pela Universidade Federal do Rio Grande do Sul.\\[1cm]

\noindent Prof. Dr. João da Silva\\
Doutor em Educação pelo Instituto Federal Sul-rio-grandense.\\[1cm]

\noindent Prof. Dr. Paulo Reglus Neves Freire\\
Doutor em Educação pela Universidade de Harvard.\\[1cm]

% \noindent Prof. Dr. Outro Avaliador\\
