\documentclass[tese,capa]{texifsuledu}
...
\curso{Doutorado Profissional em Educação e Tecnologia}
\areaconhecimento{Educação}
\tituloformacao{Doutor em Educação e Tecnologia}

\unidadeeng{Pelotas Campus}
\programaeng{Postgraduate Program in Education}
\cursoeng{Professional Master in Education and Technology}

\title{Modelo de Tese de Doutorado do Programa de Pós-Graduação em Educação do IFSul}
...
\noindent Prof. Dr. Edgar Morin\\
Doutor em Filosofia pela Universidade de Paris.\\[1cm]
